...
/**
 * This class provides a wrapper for network errors when making requests to Visier Permission Management APIs
 */
export class VisierPermissionManagementError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "VisierPermissionManagementError";
